...
var h = (n3) => __async(null, null, function* () {
  if (n3.leavingEl && n3.animated && 0 !== n3.duration) return n3.animationBuilder ? n3.animationBuilder : "ios" === n3.mode ? (yield import("./p-DWkAgceV-2Y5DFSNV.js")).iosTransitionAnimation : (yield import("./p-BsBCoGa--QJQANPDB.js")).mdTransitionAnimation;
});
...
var P2 = (e) => __async(null, null, function* () {
  ...
  return yield k(e, o), j(i2, a), D(i2, a), { hasCompleted: true };
});
...
//# sourceMappingURL=chunk-TTQ4P3N7.js.map
